...
import { Eye, EyeOff, User, Mail, Phone, Calendar, Briefcase, IdCard, ChevronLeft, ChevronRight } from 'lucide-react'
...
export default function RegistroForm() {
  ...
  const handleInputChange = (field: keyof RegistroAdoptanteData, value: any) => {
  ...
  const renderStep1 = () => (
    <div className="space-y-4">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600">Información básica y de contacto</p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={cn("pl-10", errors.nombres?.length > 0 && "border-red-500")}
      ...
      <div className="space-y-2">
        <Label htmlFor="apellido_paterno">Apellido Paterno <span className="text-red-500">*</span></Label>
        <div className="relative">
          <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
          <Input
            id="apellido_paterno"
            ...
            className={cn("pl-10", errors.apellido_paterno?.length > 0 && "border-red-500")}
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={cn("pl-10", errors.email?.length > 0 && "border-red-500")}
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={cn("pl-10", errors.telefono?.length > 0 && "border-red-500")}
  ...
  const renderStep2 = () => (
    <div className="space-y-4">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600">Datos complementarios (opcionales)</p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={cn("pl-10", errors.fecha_nacimiento?.length > 0 && "border-red-500")}
            disabled={isLoading}
          />
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={cn("pl-10", errors.ocupacion?.length > 0 && "border-red-500")}
  ...
  const renderStep3 = () => (
    <div className="space-y-4">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600">Configura tu contraseña y acepta los términos</p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input
            ...
            className={cn(errors.confirmPassword?.length > 0 && "border-red-500")}
      ...
      <CardContent>
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          {errors.general?.map((error, index) => (
            <div key={index} className="mt-4 p-3 bg-red-50 border border-red-200 rounded-md">
