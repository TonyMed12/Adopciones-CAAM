...
export default function FormMascota({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const payload: any = {
      ...
      imagen_url: fotoPreview || mascota?.imagen_url || null,
      colores,
      lugar_rescate,
    ...
    try {
      ...
      if (mascota?.id) {
        ...
        result = await crearMascota(payload);
      ...
      <div className="row">
        ...
        <div className="field">
          ...
          <input
            ...
            value={edadMeses}
            onChange={(e) =>
              setEdadMeses(parseInt(e.target.value || "0", 10))
            }
          />
        </div>
      </div>
      ...
      <div className="row">
        <div className="field">
          ...
          <input
            ...
            value={pesoKg}
            onChange={(e) =>
              setPesoKg(parseFloat(e.target.value) || 0)
            }
          />
        </div>
        <div className="field">
          ...
          <input
            ...
            value={alturaCm}
            onChange={(e) =>
              setAlturaCm(parseFloat(e.target.value) || 0)
            }
          />
        </div>
      </div>
