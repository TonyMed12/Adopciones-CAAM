      ...
      {seguimientos.length === 0 ? (
        ...
        <div className="grid gap-6">
          {seguimientos.map((s, i) => {
            // convertir estado_mascota a texto bonito
            ...
            const estadoTexto =
              estadoLabels[s.estado_mascota] || "No Registrado";
            const estadoColor =
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-700">
                    {s.observaciones?.replace(/^\w/, (c: string) =>
                      c.toUpperCase()
                    )}
                  </p>
                </div>
                ...
                {s.recomendaciones && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-700">
                      {s.recomendaciones.replace(/^\w/, (c: string) =>
                        c.toUpperCase()
                      )}
                    </p>
                  </div>
